...
<footer id="Footer">
	...
	<div class="container">
		<div class="column one copyrights">
			<p>
				&copy; <?php echo date( 'Y' ); ?> <strong><?php bloginfo( 'name' ); ?></strong>. <?php _e('All Rights Reserved.','kora'); ?><br />
				<?php _e('Powered by','kora'); ?> <a target="_blank" href="http://wordpress.org">WordPress</a>. <?php _e('Created by','kora'); ?> <a target="_blank" href="http://themeforest.net/user/muffingroup/portfolio?ref=muffingroup">Muffin group</a>
			</p>
