	...
	class MFN_Options{
		...
		*/
		function __construct( $menu = array(), $sections = array() ){
			...
			$defaults['opt_name'] = 'kora';
			
			$defaults['menu_icon'] = MFN_OPTIONS_URI.'/img/menu_icon.png';
			$defaults['menu_title'] = __('Kora Theme Options', 'mfn-opts');
			$defaults['page_icon'] = 'icon-themes';
			$defaults['page_title'] = __('Kora Theme Options', 'mfn-opts');
					...
					echo '<div id="mfn-aside">';
						...
						echo '<ul class="mfn-menu">';
							...
							echo '<li class="mfn-menu-li mfn-menu-li-import">';
								echo '<a href="javascript:void(0);" class="mfn-menu-a">'. $icon .'<span>'. __('Import & Export', 'mfn-opts'). '</span></a>';
								echo '<ul class="mfn-submenu">';
									echo '<li id="import-mfn-submenu-li" class="mfn-submenu-li">';
										echo '<a href="javascript:void(0);" class="mfn-submenu-a" data-rel="import">'. $icon .'<span>'. __('Import & Export', 'mfn-opts'). '</span></a>';
									echo '</li>';
								echo '</ul>';
							echo '</li>';
							...
							echo '<div id="import-mfn-section" class="mfn-section">';
								...
								echo '<div class="mfn-import-wrapper">';
									...
									echo '<div class="mfn-import-box mfn-import-imp">';
										...
										echo '<p>';
											echo '<a href="javascript:void(0);" class="button-secondary mfn-import-imp-code-btn">'.__('Import from file', 'mfn-opts').'</a>&nbsp;';
											echo '<a href="javascript:void(0);" class="button-secondary mfn-import-imp-link-btn">'.__('Import from URL', 'mfn-opts').'</a>';
										echo '</p>';
										...
										echo '<p class="mfn-import-imp-action">';
											echo '<input type="submit" id="mfn-opts-import" name="'.$this->args['opt_name'].'[import]" class="button-primary" value="'.__('Import', 'mfn-opts').'">';
									...
									echo '<div class="mfn-import-box mfn-import-exp">';
										...
										echo '<p>';
											echo '<a href="javascript:void(0);" class="button-secondary mfn-import-exp-code-btn">'.__('Copy', 'mfn-opts').'</a>&nbsp;';
											echo '<a href="'. esc_url( add_query_arg(array('feed' => 'mfn-opts-'.$this->args['opt_name'], 'action' => 'download_options', 'secret' => md5(AUTH_KEY.SECURE_AUTH_KEY)), site_url()) ) .'" class="button-primary mfn-import-exp-download-btn">'.__('Download', 'mfn-opts').'</a>&nbsp;';
											echo '<a href="javascript:void(0);" class="button-secondary mfn-import-exp-link-btn">'.__('Copy Link', 'mfn-opts').'</a>';
										echo '</p>';
										...
										echo '<textarea class="large-text mfn-import-exp-code" rows="8">';print_r($encoded_options);echo '</textarea>';
