...
function mfn_offer_post_type() 
{
	...
	$args = array(
		...
		'supports' => array( 'editor', 'excerpt', 'page-attributes', 'thumbnail', 'title' ),
	); 
...
$mfn_offer_meta_box = array(
	...
	'fields' => array(
		...
		array(
			...
			'sub_desc' => __('Custom Single Offer Page Link', 'mfn-opts'),
			'desc' => __('Leave this field blank if you want this item link to the Offer Page.', 'mfn-opts'),
		),
