		...
		'feature_box' => array(
			...
			'fields' => array(
				...
				array(
					'id' => 'background',
					'type' => 'select',
					'title' => __('Text Bar color', 'mfn-opts'),
		...
		'offer' => array(
			...
			'fields' => array(
				...
				array(
					'id' => 'info',
					'type' => 'info',
					'desc' => __('Please don\'t include multiple Offer Sliders on one page.', 'nhp-opts'),
				),
		...
		'testimonials' => array(
			...
			'fields' => array(
				...
				array(
					...
					'type' => 'text',
					'title' => __('Title', 'mfn-opts'),
					'std' => __('What Clients Says', 'mfn-opts'),
				),
...
function mfn_print_feature_box( $item ) {
	echo sc_feature_box( $item['fields'] );
}
