...
$mfn_testimonial_meta_box = array(
	...
	'fields' => array(
		...
		array(
			...
			'sub_desc' => __('Author shown above the testimonial.', 'mfn-opts'),
		),
		...
		array(
			...
			'sub_desc' => __('Text of link shown above the testimonial.', 'mfn-opts'),
		),
		...
		array(
			...
			'sub_desc' => __('Link shown above the quote', 'mfn-opts'),
		),
